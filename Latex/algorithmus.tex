...
\begin{equation}
  \delta = \arccos{\left(\frac{\vec{B}_y}{\abs{\vec{B}}}\right)}
\end{equation}
...
\begin{equation}
  \gamma = \arccos{\left(\frac{\vec{v}_y}{\abs{\vec{p}_v}}\right)}
\end{equation}
...
Anschluss wieder in die alte Basis zur\"ucktransformiert werden. Zu diesem Zweck kann einfach die \textit{Inverse} Matrix von \(T\)
