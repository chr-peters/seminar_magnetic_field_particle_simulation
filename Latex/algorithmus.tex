...
\begin{algorithmic}[1]
  \STATE Initialisiere Flugbahn als Liste von Teilchenzust\"anden
  \STATE F\"uge der Flugbahn den initialen Teilchenzustand hinzu
  \WHILE{Abbruchkriterium nicht erf\"ullt}
  \STATE Transformieren
  \STATE Berechnen
  \STATE Zur\"ucktransformieren
  \STATE Neuen Zustand der Flugbahn anf\"ugen
  \ENDWHILE
\end{algorithmic}
